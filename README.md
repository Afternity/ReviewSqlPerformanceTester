...
Всё что изменял + коментарии находятся в самом прокте.

P.S.: У тебя какая-то странная вложенность в проекте, только на момент отрпавки заметил её, я исправил это, можешь по количиству строк в проекте понять (правда я не знаю как у тебя, может это из-за .zip?).
